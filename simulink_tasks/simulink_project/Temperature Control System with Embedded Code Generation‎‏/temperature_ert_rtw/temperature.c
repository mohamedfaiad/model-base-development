...
extern void temperature_derivatives(void);
...
void temperature_step(void)
{
  ...
  if (rtDW.Integrator_IWORK != 0) {
    rtX.Integrator_CSTATE = 0.5;
  }

  /* Step: '<Root>/set point temperature' */
  ...
  /* End of Step: '<Root>/set point temperature' */

  /* Sum: '<Root>/Sum' incorporates:
   *  Integrator: '<Root>/Integrator'
   */
  rtDW.Sum = (real_T)tmp - rtX.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(rtM)) {
...
void temperature_derivatives(void)
{
  XDot *_rtXdot;
